...
int main () try
{
	...
	vector <float> sample_3 = {1,4.5,7,9,14,17,11,9};
	vector <float> time_3 = {1,2.6,3,4,5,6,7,8};
	Signal<float, float> signal3(sample_3, time_3);
...
*/
	...
	if (!plikWyj)
		return 1;
	//ifstream plikWej ( "test_patient1.txt" );
	//if (!plikWej)
		//return 1;

	patient_1.write_date(plikWyj);
	date_1.write_date(plikWyj);
	//date_0.read_date(plikWej);
